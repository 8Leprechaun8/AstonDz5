...
public class SortByAverageGrade implements Sort {
    ...
    public List<Student> sort(List<Student> studentList) {
        ...
        for (int i = 0; i < listSize - 1; i++) {
            for (int j = 0; j < listSize - 1 - i; j++) {
                ...
                Double firstValue = (first != null) ? first.getAverageGrade() : null;
                Double secondValue = (second != null) ? second.getAverageGrade() : null;
