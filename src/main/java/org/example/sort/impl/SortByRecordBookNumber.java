...
public class SortByRecordBookNumber implements Sort {
    ...
    public List<Student> sort(List<Student> studentList) {
        ...
        for (int i = 0; i < listSize - 1; i++) {
            for (int j = 0; j < listSize - 1 - i; j++) {
                ...
                Integer firstValue = (first != null) ? first.getRecordBookNumber() : null;
                Integer secondValue = (second != null) ? second.getRecordBookNumber() : null;
